...
open class LooprDepthList : RealmObject() {
    ...
    // TODO GET RID OF ME KNUCKEY AFTER FIXING THIS CLASS (REALM NEEDS AT LEAST 1 PERSISTABLE FIELD, HENCE THIS IS A PLACEHOLDER)
    var dummyString = ""
     ...
     */
    // TODO FIX ALL OF THIS WITH NEW CLASS
...
//
//                val depthJsonArray = json.asJsonArray
//
//                depthList.list = RealmList()
//                depthJsonArray.forEach {
//                    val depthJsonArrayElement = it.asJsonArray
